...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Perform login logic here, such as API calls, validation, etc.
  ...
  return (
    <>
      <NavBar />
      <div id="login" tabIndex="-1" className=" overflow-y-auto overflow-x-hidden mt-40  h-full items-center justify-center flex">
            ...
            <div className="p-5">
              ...
              <div className="mt-7 flex flex-col gap-2">
                <button className="inline-flex h-10 w-full items-center justify-center gap-2 rounded border border-slate-300 bg-white p-2 text-sm font-medium text-black outline-none focus:ring-2 focus:ring-[#333] focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-60">
                  <img src="https://www.svgrepo.com/show/475647/facebook-color.svg" alt="GitHub" className="h-[18px] w-[18px] " />
              ...
              <form className="w-full" onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  className="block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-black focus:ring-offset-1 text-black" // Added text-black here
                ...
                <input
                  ...
                  className="mt-2 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-black focus:ring-offset-1 text-black" // Added text-black here
     ...
     <div className='fixed bottom-0 right-0 left-0 z-50'> <Footer /></div>
    </>
  );
};
